            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/franchise" className="w-full">
                      {t.header.franchise}
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
          ...
          <div className="flex min-w-0 items-center gap-2 md:gap-3">
            <Link href="/" className="block shrink-0">
              <Image
                src="/logo.jpg"
                alt="YGF Australia"
                className="h-12 w-auto object-cover sm:h-14 md:h-16"
                width={165}
                height={165}
              />
            </Link>
            ...
            <Separator
              ...
              className="hidden h-4 bg-white/20 md:block"
            />
            <nav className="hidden md:flex items-center gap-2">
              <Button
                ...
                size="lg"
                asChild
                className="text-xl text-bold text-white hover:bg-white/10 hover:text-white data-[state=open]:bg-white"
              >
                <Link href="/">Home</Link>
              </Button>
              <Button
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            {!user && (
              <Button
                ...
                size="sm"
                asChild
                className="bg-primary text-white hover:bg-primary/90 hover:text-white data-[state=open]:bg-white/10 md:h-10 md:px-6"
              >
