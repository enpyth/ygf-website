    ...
    <footer className="relative bg-black text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <p className="text-sm leading-relaxed max-w-xs text-white">
                YGF Australia is the exclusive master franchisee of Yang Guofu
                in Australia. With over 7,000 stores worldwide, YGF is China’s
                most renowned and pioneering hotpot brand.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <div className="space-y-2 text-sm">
                <p className="flex items-center gap-2 text-white/90">
                  ...
                  <span>088 268 7898</span>
                </p>
                <p className="flex items-center gap-2 text-white/90">
                  <Mail className="h-4 w-4 text-white/80" />
                  <span>admin@ygfaustralia.com</span>
                </p>
                <p className="flex items-center gap-2 text-white/90">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <div className="flex space-x-4">
                <Link
                  href="https://www.instagram.com/ygfaus"
                ...
                <Link
                  href="https://www.tiktok.com/@ygfaustralia"
                  aria-label="TikTok"
                  className="text-white/80 hover:text-white transition-colors"
                >
                ...
                <Link
                  href="https://facebook.com/ygfaus"
                  aria-label="Facebook"
                  className="text-white/80 hover:text-white transition-colors"
                >
                ...
                <Link
                  href="https://xhslink.com/m/9VUoftRL2IE"
      ...
      <Dialog open={wechatOpen} onOpenChange={setWechatOpen}>
        <DialogContent className="sm:max-w-md bg-black border-white/20">
          <DialogHeader>
            <DialogTitle className="text-white text-center">Scan to Add WeChat</DialogTitle>
          </DialogHeader>
          <div className="flex justify-center p-4">
            <Image
              src="/footer/wx_code.jpg"
              alt="WeChat QR Code"
              width={250}
              height={250}
